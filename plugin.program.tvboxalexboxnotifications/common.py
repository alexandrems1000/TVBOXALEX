...
#import common
addon_id='plugin.program.tvboxalexboxnotifications'
...
DefaultSplitter="|||"; 
DefaultUrl="https://dl.dropbox.com/s/o5a0f3msenrqsos/NOTIFICA%C3%87%C3%95ES%20TVBOXALEX.txt?dl=0"; 
class MyWindow(xbmcgui.WindowDialog): #xbmcgui.Window): ##xbmcgui.Window
	...
	def __init__(self,noteType='t',noteMessage='',noteImage='',L=140,T=110,W=1000,H=500,Font='font14',TxtColor='0xFF64d1ff'):
		...
		self.buttonDismiss=xbmcgui.ControlButton(l1,t1,w1,h1,"Percebi",textColor="0xFF000000",focusedColor="0xFF000000",alignment=2,focusTexture=focus,noFocusTexture=nofocus); 
		self.buttonRemindMe=xbmcgui.ControlButton(l2,t2,w2,h2,"Lembrar mais tarde",textColor="0xFF000000",focusedColor="0xFF000000",alignment=2,focusTexture=focus,noFocusTexture=nofocus); 
		#self.OlaySplash
