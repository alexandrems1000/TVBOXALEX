...
def resetAddon():
    ...
    d = xbmcgui.Dialog()
    d.ok('[COLOR red][B] TVBOXALEX BUILD[/B][/COLOR]', 'Build addon_data now removed.', 'Your locally stored builds will be unaffected but your', 'settings have now reset back to the defaults.')
